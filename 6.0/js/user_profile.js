    ...
    if (typeof firebase !== 'undefined') {
      if (!firebase.apps.length) {
        ...
        try {
          ...
          // Activate Firebase App Check (reCAPTCHA v3 / Enterprise)
        ...
        this.db.collection('users').doc(this.uid).get().then(doc => {
          if (doc.exists) {
            ...
            if (remoteXP >= this.data.xp) {
              ...
              if (typeof StoryMode !== 'undefined' && typeof StoryMode.loadState === 'function') {
                StoryMode.loadState();
              }
            }
          } else {
